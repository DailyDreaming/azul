...
class ElasticTransformDump:
    ...
    def _annotate_aggs_for_translation(self, es_search: Search):
        """
        Annotate the agregations in the given ES search request so we can later
        translate any null values in aggregation results in the response.
        """
    ...
    def _translate_response_aggs(self, es_response: Response):
        """
        Translate None in values in the aggregations part of an ES response.
        """
